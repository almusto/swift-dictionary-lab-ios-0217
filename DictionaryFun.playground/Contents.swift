 ...
 */
// dictionary of string : string key /value pairs
...
if let capital = capitals["Pennsylvania"] {
  print("Pennsylvanaia's capital is \(capital)")
}
...
if let ny = capitals[state] {
  print("The capital of \(state) is \(ny)")
}
...
var bandmembers = ["Nirvana" : ["Kurt Cobain",
                                "Krist Novoselic",
                                "Dave Grohl"],
 ...
 */
//dictionary of string : array of strings key value pairs
...
if let pixiesMembers = bandmembers[bandName] {
  print(pixiesMembers)
}
